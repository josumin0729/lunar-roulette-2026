...
// 금액별 확률 설정
const prizes = [
    { amount: '5천🧧', weight: 30, message: '새해 스타트 버프 획득 ✨' },
    { amount: '1만🧧', weight: 25, message: '새해 행운 포인트 적립 완료 💰' },
    { amount: '3만🧧', weight: 20, message: '새해 난이도 이지 모드 확정 🎮' },
    { amount: '5만🧧', weight: 15, message: '새해부터 인생 난이도 내려간 느낌입니다\n감사합니다 😄' },
    { amount: '10만🧧', weight: 8, message: '새해 시작하자마자\n인생 그래프 급상승했습니다\n감사합니다 📈' },
    { amount: '50만🧧', weight: 2, message: '새해부터 가문 위상 상승했습니다\n정말 감사합니다 🙇‍♀️🔥' }
];

const sliceMapping = ['5천🧧', '1만🧧', '3만🧧', '5만🧧', '10만🧧', '50만🧧'];
